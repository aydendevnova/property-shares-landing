      ...
      <div className="mx-auto max-w-[90rem] px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div id="waitlist" className="space-y-4">
              {!isSubmitted ? (
                ...
                <div className="flex items-center gap-3 p-4 rounded-lg bg-green-50 border border-green-200 max-w-md">
          ...
          <div className="relative lg:pl-8">
            ...
            <div className="absolute -top-4 -right-4 p-3 bg-white rounded-xl shadow-lg border border-slate-100 hidden lg:flex items-center gap-3">
            ...
            <div className="absolute -bottom-4 -left-4 p-3 bg-white rounded-xl shadow-lg border border-slate-100 hidden lg:flex items-center gap-3">
